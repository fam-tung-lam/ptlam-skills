import type { CategoryInput } from "../../../../../../tools/plugin-compiler/models/category.ts";
import type { PluginModel } from "../../../../../../tools/plugin-compiler/models/plugin.ts";
import type { ManifestSkill } from "../../../../../../tools/plugin-compiler/models/skill.ts";

export interface MutablePluginCatalog
  extends Omit<PluginModel, "categories" | "skills"> {
  categories: CategoryInput[];
  skills: ManifestSkill[];
}

export function makePluginCatalogFixture(): MutablePluginCatalog {
  return {
    schema_version: 2,
    name: "fixture-skills",
    version: "1.2.3",
