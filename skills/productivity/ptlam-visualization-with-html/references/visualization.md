...
| Comparable quantities          | Compare magnitude or composition   | Aligned values, bars, plot, or table           |
...
| Spatial layout                 | Understand position or proximity   | Map, floor plan, or labeled coordinate view    |
