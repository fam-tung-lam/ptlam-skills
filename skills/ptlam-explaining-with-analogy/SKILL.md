...
description:
  ...
  caveats. Use whenever the user wants to understand a concept, including
  requests such as explain, what is, how does it work, ELI5, break this down,
  help me understand, or give me an analogy. Use even when the user does not
